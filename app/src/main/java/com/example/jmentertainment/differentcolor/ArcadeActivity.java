...
public class ArcadeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        timer = new CountDownTimer((int)time * 1000, 100){
            public void onTick(long millisUntilFinished){
                time = time - 0.1f;
                ((TextView)findViewById(R.id.arcadeModeTimer)).setText(dformat.format(time));
            }
            public void onFinish(){
                ((TextView)findViewById(R.id.arcadeModeTimer)).setText("0.0");
                disableButton();
            }
        }.start();
    }
    ...
    private void initializeStageMap(){
        LinearLayout layout = (LinearLayout)findViewById(R.id.arcadeModeLayout);
    ...
    private void setStageButton(){
        ...
        for(int i = 0; i < arcadeModeNum; i++){
            ...
            for(int j = 0; j < arcadeModeNum; j++) {
                ...
                btn.setWidth((screenShorterSideLength - 100) / arcadeModeNum);
                btn.setHeight((screenShorterSideLength - 100) / arcadeModeNum);
    ...
    private void addScore(){
        ...
        score += arcadeModeNum * arcadeModeNum;

        // Prints the score on the screen.
        TextView txt = (TextView) findViewById(R.id.arcadeModeScore);
        if(score >= 100000){
    ...
    private void setAnswerButton(){
        Random r = new Random();
        int row = r.nextInt(arcadeModeNum);
        int col = r.nextInt(arcadeModeNum);
    ...
    public void onBackPressed() {
        ...
        LinearLayout layout = (LinearLayout)findViewById(R.id.arcadeModeLayoutBg);
        ...
        exitBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                timer.cancel();
                popupWindow.dismiss();
                startActivity(new Intent(ArcadeActivity.this, PregameActivity.class));
                finish();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_arcade, menu);
        return true;
    }
